...
float piggybank::calcPiggybankNotes(piggybank piggy)
{
...
float piggybank::calcPiggybankCoins(piggybank piggy)
{
...
float piggybank::calcPiggybankTotal(piggybank piggy)
{
